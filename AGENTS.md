...
| **EP-08** `api-gateway`          | ✅ 47 tests, routes MAM, proxies bodies byte-transparently, **08.3 rate limiting + size caps** (per replica — see README). **08.5 aggregated `GET /reference`**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
