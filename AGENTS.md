...
| **EP-11** Studio shell (Angular) | ✅ 11.1 skeleton, **11.2 real sign-in against IAM**, 11.3 the workbench, 11.7 `can()` rendering — 66 tests. **11.5 generated API clients** (`npm run api:check`). ⬜ 11.4 ws, 11.6 i18n/RTL                                                                                                             |
| **EP-20** Studio panels          | ✅ **20.1 Media panel** — recent/search/tag filters against real MAM. ⬜ browse tree blocked on #260 (categories are a field, not an entity), 20.2+                                                                                                                                                     |
