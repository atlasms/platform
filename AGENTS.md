...
| **EP-13** walking skeleton       | ✅ 12 tests incl. **13.3 one trace across gateway → service → broker → consumer** + **13.4 smoke suite green** (14/14, run against kind). **13.2 COMPLETE and OBSERVED** — the last hop, outbox → broker → bridge → socket, is asserted by a smoke test that holds a real socket open while a write goes through the gateway, and it passes against a live cluster.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
be removed without the build saying so. Plus **15 smoke tests** against a deployed cluster (not in
CI — there is no cluster there, #126). Last run green on kind, 2026-09-10, including the EP-13.2
live-update path end to end.
